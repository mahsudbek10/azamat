...
<script>
        ...
        <?php $cities=R::getAll("SELECT * FROM azamat_city");
                ...
                marker.bindPopup('<b><?= $item['name'] ?></b><br><img src="<?= $item['img'] ?>" width="300px"><br>Резюме: <?= count($rezume_count); ?><br>Вакансии: <?= count($vacancy_count); ?><br><a href="admin/more?city=<?= $item['id'] ?>" target="_blank">Подробнее</a>').openPopup();
